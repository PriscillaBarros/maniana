...
public class ColorPickerView extends View {
    ...
    /**
     * Suppress setting of V, allow to change only H, S and possibly A. V is fixed to max.
     */
    private boolean mJustHSNoV = false;

    /**
     * Limits the sat range to [0..mMaxSat]. TODO: expose to external setting. Currently fixed to
     * Maniana widget paper requirements.
     */
    ...
    /**
     * Offset from the edge we must have or else the finger tracker will get clipped when it is
     * drawn outside of the view.
     */
    ...
    private void drawSatValPanel(Canvas canvas) {
        ...
        //
        Shader mShader = mJustHSNoV ? mSatShader : new ComposeShader(mValShader, mSatShader,
    ...
    /**
     * Get the drawing offset of the color picker view. The drawing offset is the distance from the
     * side of a panel to the side of the view minus the padding. Useful if you want to have your
    ...
    /**
     * Set if the user is allowed to adjust the alpha panel. Default is false. If it is set to false
     * no alpha will be set.
     * 
     * @param visible
     */
    public void setAlphaSliderVisible(boolean visible) {
        ...
        if (mShowAlphaPanel != visible) {
            ...
            /*
             * Reset all shader to force a recreation. Otherwise they will not look right after the
